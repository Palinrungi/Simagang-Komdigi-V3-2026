...
@push('styles')
    <style>
        ...
        *, body { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .badge-no-revision { background: #dcfce7; color: #15803d; }
        ...
        .file-link:hover { color: #1e40af; text-decoration: underline; }
        .file-link i { color: #ef4444; font-size: 12px; }
        ...
        .action-btn.grade { color: #22c55e; }
        .action-btn.grade:hover { background: #dcfce7; }
        .action-btn.view { color: #3b82f6; }
        .action-btn.view:hover { background: #dbeafe; }
        .action-btn.cert { color: #f59e0b; }
        .action-btn.cert:hover { background: #fef3c7; }
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 120px; text-align: center;">Serah Terima</th>
                        ...
                        <tbody>
                            @forelse($reports as $r)
                                <tr>
                                    ...
                                    {{-- Kolom Indikator Serah Terima Proyek --}}
                                    <td style="text-align: center;">
                                        @if($r->project_handover_agreement)
